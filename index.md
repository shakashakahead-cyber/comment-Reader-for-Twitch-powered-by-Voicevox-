Privacy Policy for Comment Reader for Twitch (powered by Voicevox)
日本語 (Japanese)
最終更新日: 2025年12月3日
...
2. マイク権限の使用目的について
本拡張機能は「マイクへのアクセス権限」を要求しますが、これは音声出力デバイス（スピーカー）の名称を取得するためだけに使用されます。
...
2. Usage of Microphone Permission

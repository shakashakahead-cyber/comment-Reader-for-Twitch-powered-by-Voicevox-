...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('btnOpenDictionary').addEventListener('click', () => {
        if (chrome.runtime.openOptionsPage) {
            ...
            // NOTE: options.html path might change. 
            // But chrome.runtime.getURL('options.html') usually resolves from manifest options_ui_page? 
            // Or relative to root. 
            // We will fix manifest so options page is registered there.
